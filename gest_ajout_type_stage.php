					...
					<div class="app-card app-card-chart h-100 shadow-sm">
						<div class="app-card-header p-3">
							<div class="row justify-content-between align-items-center">
								<div class="col-auto">
									<h4 class="app-card-title">Nouveau Type de Stage </h4>
								</div>
							</div>
						</div>
						<div class="app-card-body p-3 p-lg-4">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<input type="text" id="type_de_stage" name="type_de_stage" placeholder=" ">
							...
							<div class="row">
								<div class="col-md-2">
									<button id="btn-save-new-type-stage" class="btn btn-add">Enregistrer</button>
								</div>
							</div>
						</div>
					</div>
